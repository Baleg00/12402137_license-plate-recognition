...
from UNet import Down, Up, ConvBlock, SEBlock, CBAM, DilatedConvBlock, UNetSmall
...
def test_unetsmall_forward_output_shape(H: int, W: int) -> None:
    ...
    """
    net = UNetSmall(in_ch=3, base_ch=32)
...
def test_backward_pass_through_blocks() -> None:
    ...
    """
    net = UNetSmall(in_ch=3, base_ch=16)  # smaller for speed
